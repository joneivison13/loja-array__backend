...
var CartController_1 = __importDefault(require("./controller/CartController"));
...
// cart
routes.get("/cart", token_1.checkJwt, CartController_1.default.list);
routes.post("/cart", token_1.checkJwt, CartController_1.default.create);
routes.delete("/cart", token_1.checkJwt, CartController_1.default.remove);
